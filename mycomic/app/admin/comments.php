                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title text-center">用户留言评论列表</h3>
                            <div class="box-tools">
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $result['addtimec'] ?></td>
                                    <td>
...
<script>
    ...
    function del(id,table) {
        if(confirm('确定删除此评论吗？')){
        $.post('/mycomic/app/admin/handler/del_comment.handler.php',{id:id,table:table},function(data){
            if(data.result == 1) {
                alert(data.message);
    ...
    function check_comment(id){
         $.post('/mycomic/app/admin/handler/check_comment.handler.php',{id:id},function(data){
            if(data.result == 1) {
                alert(data.message);
                window.location.reload();
            }
