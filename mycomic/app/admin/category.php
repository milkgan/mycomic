...
?>
  ...
  <div class="content-wrapper">
        <section class="content" id="showcontent" style="margin-top: 50px">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="box-header">
                            ...
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <a href="/mycomic/app/admin/add_category.php"><button class="btn btn-success">添加分类</button></a>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function delcategory(id,table) {
        if(confirm('确定删除此数据吗？')){
        $.post('/mycomic/app/admin/handler/del_category.handler.php',{id:id,table:table},function(data){
            if(data.result == 1) {
                alert(data.message);
