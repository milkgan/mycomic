    ...
    <div class="col-md-9">
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                <form role="form" action="/mycomic/app/home/handler/profile.handler.php" method="post" enctype=multipart/form-data>
                    <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_phone" class="form-control" placeholder="住址" value="<?php echo $user['address'] ?>" name="address" type="text" autofocus>
                            </div>
