                ...
                <div class="panel-body">
                    <form role="form">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label for="input_password"><span class="glyphicon glyphicon-lock"></span>&nbsp;确认密码</label>
                            ...
                            <div href="javascript:void(0)" onclick="register()" class="btn btn-lg btn-success btn-block">注册</a>
                        </fieldset>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function register(){
         ...
         $.post("/mycomic/app/home/handler/register.handler.php",{name:name,email:email,password_o:password_o,password:password}, function(data){
            if( data.result == 1 ){
                alert('注册成功');
