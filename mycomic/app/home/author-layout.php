<div class="col-md-3">
    <nav class="menu" data-ride="menu" style="width: 200px">
          <ul id="treeMenu" class="tree tree-menu" data-ride="tree">
            ...
            <li><a href="/mycomic/app/home/renzheng.php"><i class="fa fa-user"></i>作者信息</a></li>
            <li><a href="/mycomic/app/home/add_zuopin.php"><i class="fa fa-pencil"></i>我要投稿</a></li>
            <li><a href="/mycomic/app/home/zuopin.php"><i class="fa fa-book"></i>我的作品</a></li>
          </ul>
        </nav>
</div>