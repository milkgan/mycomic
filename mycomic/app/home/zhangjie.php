...
<div class="container">
<div class="row">
<div class="col-sm-10 col-sm-offset-3" style="margin-top: 7%">
	<div class="row">
	<div class="col-sm-3">
		<img src="/mycomic/<?php echo $zuopin['zuopin_img'] ?>" width="250px" height="250px">
	</div>
    ...
    <p style="margin-top:1%;font-size:14px"><i class="fa fa-newspaper-o"></i>简介：<?php echo $zuopin['zuopin_description'] ?></p>
                    ...
                    <div class="panel-heading">
                      ...
                      <div class="panel-body">
                            ...
                            ?>
                                <div class="comment">
                                  <a href="###" class="avatar">
                                    <img src="/mycomic/<?php echo $comment['avatar'] ?>" class="img-cricle">
                                  </a>
                                  <div class="content">
...
<script>
    ...
    function commit() {
        ...
        console.log(zuopin_id)


        $.post('/mycomic/app/home/handler/commit.handler.php',{comment_content:comment_content,zuopin_id:zuopin_id},function(data){
                if(data.result == 1) {
                    alert(data.message);
    ...
    function show(id) {
        $.post('/mycomic/app/home/handler/show.handler.php',{id:id},function(data){
                if(data.result == 1) {
    ...
    function shoucang(id) {
         $.post('/mycomic/app/home/handler/collection.handler.php',{id:id},function(data){
                if(data.result == 1) {
                    alert(data.message);
                    window.location.reload();
                }
